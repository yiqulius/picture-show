...
public class CardItemTouchHelperCallback2<T> extends ItemTouchHelper.Callback {

    private final RecyclerView.Adapter adapter;
    private List<T> dataList;
    private OnSwipeListener<T> mListener;

    public CardItemTouchHelperCallback2(@NonNull RecyclerView.Adapter adapter, @NonNull List<T> dataList) {
